...
export default function ResultsPage() {
  ...
  // Group questions by topic, in the order they appear in topicAnalysis (worst → best)
  ...
  if (loading) return <div className="flex items-center justify-center h-[60vh]" style={{ color: "var(--text-secondary)", fontFamily: "var(--font-mono)" }}>Loading results…</div>;
  if (!data || !data.questions) return <div className="flex items-center justify-center h-[60vh]" style={{ color: "var(--text-secondary)" }}>No results to show.</div>;
    ...
    <div className="flex flex-col" style={{ gap: 56 }}>
      ...
      <div className="grid grid-cols-2" style={{ gap: 32 }}>
        <Card className="text-center" style={{ padding: "56px 32px" }}>
          ...
          <div className="text-[96px] leading-none font-normal mb-4" style={{ fontFamily: "var(--font-mono)", color: scorePercent >= 70 ? "var(--mint)" : scorePercent >= 40 ? "var(--amber)" : "var(--crimson)" }}>
            {data.score}
          </div>
        ...
        <Card className="text-center" style={{ padding: "56px 32px" }}>
          ...
          <div className="text-6xl font-normal mb-4" style={{ fontFamily: "var(--font-mono)", color: "var(--cyan)", letterSpacing: "0.02em" }}>
          ...
          <div className="h-2 rounded-full overflow-hidden" style={{ background: "var(--border-subtle)" }}>
            <div
              ...
              style={{ width: `${Math.min(100, (data.timeTaken / data.timeLimit) * 100)}%`, background: data.timeTaken > data.timeLimit ? "var(--crimson)" : "var(--cyan)" }}
            />
          </div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-4" style={{ gap: 24 }}>
        {[
          { name: "Correct", value: data.correct, color: "var(--mint)" },
          { name: "Incorrect", value: data.incorrect, color: "var(--crimson)" },
          { name: "Skipped", value: data.skipped, color: "var(--text-secondary)" },
          ...
          <Card key={s.name} className="text-center" style={{ padding: "32px 20px" }}>
            <div className="text-[11px] uppercase tracking-wider mb-4 font-mono" style={{ color: "var(--text-secondary)" }}>{s.name}</div>
      ...
      {/* Combined: Topic-wise Response Review */}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 h-1.5 rounded-full overflow-hidden" style={{ background: "var(--border-subtle)" }}>
                        <div
                          ...
                          style={{ width: `${topic.accuracy}%`, background: accent }}
                        />
                      </div>
                    </div>
                  </div>
