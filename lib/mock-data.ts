...
export const CHAPTER_ACCURACY: ChapterAccuracy[] = [
  { name: "Mechanics", acc: 78 },
  { name: "Thermodynamics", acc: 45 },
  { name: "Electrostatics", acc: 62 },
  { name: "Optics", acc: 85 },
  { name: "Modern Physics", acc: 38 },
  { name: "Organic Chemistry", acc: 55 },
  { name: "Inorganic Chemistry", acc: 72 },
  { name: "Physical Chemistry", acc: 58 },
  { name: "Algebra", acc: 91 },
  { name: "Calculus", acc: 68 },
  { name: "Coordinate Geometry", acc: 33 },
  { name: "Vectors", acc: 76 },
];
